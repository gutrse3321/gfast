...
//                            "Content-Disposition": {
//                                "type": "string",
//                                "description": " \"attachment; filename=\\\"gfast.zip\\"
//                            },
//                            "Content-Length": {
//                                "type": "string",
//                                "description": " \"len(bytes)"
//                            },
//                            "Content-Type": {
//                                "type": "string",
//                                "description": "application/octet-stream; charset=UTF-8"
//                            }
//                        }
//                    }
//                }
...
//TODO 2020-8-25 加载gf swagger --pack生成的json文件
var SwagJSON string

func init() {
	content, err := ioutil.ReadFile("swagger/swagger.json")
	if err != nil {
		panic(err)
	}
	SwagJSON = string(content)
}
